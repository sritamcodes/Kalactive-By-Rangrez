...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || $categoryId <= 0 || $price <= 0) {
        ...
        try {
            $stmt = $db->prepare("INSERT INTO products (category_id, title, slug, description, price, stock, image, is_featured) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([$categoryId, $title, $slug, $description, $price, $stock, $imageName, $isFeatured]);
...
<head>
    ...
    <title>Add Product | Kalactive Admin</title>
            ...
            <div style="background: var(--card-bg); padding: 2rem; border-radius: var(--radius); border: 1px solid var(--border-color);">
                <form method="POST" action="add-product.php" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" required placeholder="e.g. Apex Ultra Running Shoes">
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="price" class="form-control" required placeholder="49.99">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" rows="5" required placeholder="Enter product specs and materials..."></textarea>
                    </div>
                    ...
                    <div style="display: flex; gap: 1rem; margin-top: 1.5rem;">
                        <button type="submit" class="btn btn-primary" style="padding: 0.85rem 2rem;">Save Product</button>
